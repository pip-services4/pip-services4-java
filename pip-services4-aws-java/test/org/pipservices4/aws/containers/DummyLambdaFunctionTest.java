...
public class DummyLambdaFunctionTest {
    Dummy _dummy1;
    Dummy _dummy2;
    ...
    public void testCrudOperations() {
        // Create one dummy
        Dummy dummy = (Dummy) lambda.act(Map.of("cmd", "create_dummy", "dummy", _dummy1));
        ...
        dummy = (Dummy) lambda.act(Map.of("cmd", "create_dummy", "dummy", _dummy2));
        ...
        // Get all dummies
        var dummies = (DataPage<Dummy>) lambda.act(Map.of("cmd", "get_dummies"));
